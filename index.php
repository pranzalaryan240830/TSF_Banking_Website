...
<head>
    ...
    <title>Pranzal Aryan | TSF e-Banking Services</title>
</head>
        ...
        <div class="left_container">
            <div id="head">
                ...
                <div id="title">
                    ...
                    <span id="titleText2">e-Banking Services</span>
                </div>
            </div>

            <div id="footer">
                <span>Copyright &copy; TSF e-Banking</span></br>
                <span>Designed & Developed by <strong title="Pranzal Aryan" style="font-family:'Dancing Script';font-size: 1.4rem;font-weight: 700;cursor:pointer;">Pranzal Aryan</strong></span></br>
                    <a href="mailto:be15098.18@bitmesra.ac.in?subject=Mail From TSF Banking Site&body=Hello Developer" target="_blank"><img src="images/email.png" alt="Email" title="Drop me an e-mail"></a>
                    <a href="https://www.linkedin.com/in/pranzalaryan240830/" target="_blank"><img src="images/linkedin.png" alt="LinkedIn" title="Get me on LinkedIn"></a>
            </div>
        </div>
        <div class="right_container">
            <div id="location">
                <img src="images/contact.png" alt="contact">
                <span>(+91) 1800-123-123</span>
                <img src="images/location.png" style="margin-left: 60px;" alt="pin">
                <span> HQ : 1/24 Dwarka, New Delhi, India [110075]</span>
            </div>
            <div id="menu">
            ...
            <div id="CustomerCard">
                ...
                <div id="send">
                    ...
                    <option value="" default selected hidden>Choose the Reciever</option>
                            <?php 
                            $nameQuery= "SELECT * FROM `customers_table`";
...
<script type="text/javascript">
    ...
    function WDvisible(){
        ...
        $getRName="SELECT * FROM customers_table WHERE Customer_ID='$RecieverID'";
        $Reciever=mysqli_fetch_array(mysqli_query($conn,$getRName));
        $RBal=$Reciever['Current_Balance'];
        
        //Sender's DATA fetching
        $getRName="SELECT * FROM customers_table WHERE Customer_ID='$SenderId'";
...
$amountupdate1="UPDATE `customers_table` SET `Current_Balance` = '$sent' WHERE `customers_table`.`Customer_ID` = '$SenderId'";
        ...
        $amountupdate2="UPDATE `customers_table` SET `Current_Balance` = '$Recieve' WHERE `customers_table`.`Customer_ID` = '$RecieverID'";
